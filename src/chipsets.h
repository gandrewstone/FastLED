...
// as per spec: class WS2811Controller800Khz : public ClocklessController<DATA_PIN, C_NS(250), C_NS(350), C_NS(650), RGB_ORDER> {};
class WS2811Controller800Khz : public ClocklessController<DATA_PIN, C_NS(250), C_NS(250), C_NS(600), RGB_ORDER> {};
//class WS2811Controller800Khz : public ClocklessController<DATA_PIN, C_NS(100), C_NS(500), C_NS(650), RGB_ORDER> {};
//class WS2811Controller800Khz : public ClocklessController<DATA_PIN, C_NS(800), C_NS(800), C_NS(900), RGB_ORDER> {};
//class WS2811Controller800Khz : public ClocklessController<DATA_PIN, C_NS(400), C_NS(400), C_NS(450), RGB_ORDER> {};
